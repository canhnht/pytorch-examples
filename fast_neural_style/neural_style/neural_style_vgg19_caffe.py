...
def build_parser():
    ...
    eval_arg_parser.add_argument(
        "--original-colors", type=int, choices=[0, 1], default=0)
    eval_arg_parser.add_argument(
        "--output-size", help="Maximum height / width of generated image", type=int, default=512)
    ...
    for e in range(args.epochs):
        ...
        for batch_id, (x, _) in enumerate(train_loader):
            ...
            content_loss = args.content_weight * \
                mse_loss(
                    features_content_y.relu4_2,
                    features_content_x.relu4_2)

            style_loss = 0.
            for ft_y, gm_s in zip(features_style_y, gram_style):
